...
8. Набрати 100 очок
9. Зробити 50 тапів (особистий виклик)
...
Три екрани з нижньою навігацією (`@react-navigation/bottom-tabs`):
- **Гра** — ігровий екран із клікер-об'єктом та рахунком
- **Виклики** — список усіх викликів із прогресом виконання
- **Налаштування** — екран з налаштуваннями застосунку (перемикання теми, інформація про версію)

### Темна/світла тема

- Автоматичне визначення системної теми через `useColorScheme`
- Ручне перемикання через екран **Налаштування** (перемикач `Switch`)
...
| Ігровий екран | Екран викликів | Екран налаштувань |
|:---:|:---:|:---:|
| ![Main](screenshots/main.png) | ![Challenges](screenshots/challenges.png) | ![Settings](screenshots/settings.png) |
